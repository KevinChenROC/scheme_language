...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, PrimitiveProcedure):
        ...
        new_env = make_call_frame(procedure, args, env)#apply proc to args in the proc's env
...
def apply_primitive(procedure, args_scheme_list, env):
    ...
    try:
        ...
        raise SchemeError("Type error when calling the procedure.")
    # END Question 4

def eval_all(expressions, env):
    """Evaluate a Scheme list of EXPRESSIONS & return the value of the last."""
	# if second is nil, then call scheme_optimized_eval with tail = true
    # BEGIN Question 7 
    if expressions == nil:
        return okay
...
def make_call_frame(procedure, args, env):
    ...
    raise SchemeError("Unknow procedure type")
    # END Question 12
...
class Frame:
    ...
    def __init__(self, parent):
        ...
        self.bindings = {} #dictionary data structure
        self.parent = parent
